...
return (
    <View style={styles.container}>
        ...
        <Text style={styles.titleH1}>Commande En Cours</Text>
            <Text style={styles.titleH3}>Consulter les commandes de ces deux
        ...
        <View style={styles.containerTow}>
            ...
            <Text style={styles.titleH2}> les commandes s'affficheront ici . </Text>
