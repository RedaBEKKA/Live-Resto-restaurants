...
const InfoScreen = ({ navigation: { goBack }, route, navigation }) => {
    ...
    const { item, token ,count} = route.params
    ...
    return (
        <View style={styles.container}>
            ...
            <View>
                ...
                <View style={styles.containerTitle}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', margin: 10, alignItems: 'center' }}>
                        <TouchableOpacity onPress={() => navigation.navigate("Home", { item, token: token,count:count })}>
                ...
                <View style={[{ backgroundColor: '#eee', marginTop: 5, paddingVertical: 0 ,borderRadius:5,margin:5,borderWidth:1,borderColor:'#078'}]}>
                ...
                <View style={{ zIndex: 3 }}>
                    <View style={{ width: '95%', borderWidth: 1, borderColor: '#078', justifyContent: 'center', alignSelf: 'center', marginTop: 30, borderRadius: 15 }}>
                        ...
                        {ordersMap.map((i) => {
                            return (
                                <View kye={i => i.id} style={{ height: 45, backgroundColor: '#eee', paddingHorizontal: 5, marginBottom: 8, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderRadius: 5, width: '95%', alignSelf: 'center' }}>
            ...
            <TouchableOpacity style={[styles.btnScondary, { width: "70%", marginHorizontal: 10, backgroundColor: '#eee', borderRadius: 12, justifyContent: "space-evenly", alignItems: 'center', borderColor: '#078', borderWidth: 1 , marginBottom:15}]}
                    onPress={() => {
                        setBtn(false)
